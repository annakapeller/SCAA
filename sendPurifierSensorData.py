...
def lambda_handler(event, context):
    ...
    if attribute == 'temperature':
        topic_arn = 'arn:aws:sns:us-east-1:819662550576:temperaturePurifierTopic'
    elif attribute == 'air_quality':
        topic_arn = 'arn:aws:sns:us-east-1:819662550576:airQualityPurifierTopic'
    else:
        return {
            'statusCode': 400,
