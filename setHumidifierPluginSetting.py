...
def lambda_handler(event, context):
    ...
    desired_humidity = payload['desiredHumidity']
    ...
    try:
        ...
        with conn.cursor() as cursor:
            query = f"UPDATE humidifier_settings SET desiredHumidity = {desired_humidity}, energyConsumptionLevel = {energy_consumption_level}, LEDLightsMode = {led_lights_mode}, quietMode = {quiet_mode}, childLock = {child_lock} WHERE id = 1"
